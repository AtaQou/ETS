...
export const WordPositionsProvider: React.FC<WordPositionsProviderProps> = ({
    ...
    useEffect(() => {
        if (
            userInfo.userID &&
            selectedDocID && // ✅ ΝΕΟ: να υπάρχει docID, αλλιώς δεν καλούμε API
            prevZoom &&
            ...
            axios
                ...
                .then((response) => {
                    ...
                    // ✅ ΝΕΟ: αν ο server δεν στείλει data, βάλε κενό array αντί για undefined
                    setWordPositions(Array.isArray(data) ? data : []);
                })
                .catch((error) => {
